...
public class StudentOperations {
    ...
    public StudentOperations(Authentication authenInterface) {
        this.authenInterface = authenInterface;
    }

    public StudentOperations(DRRS drrsServerInterface, String studentID) {
        this.drrsServerInterface = drrsServerInterface;
        this.studentID = studentID;
        startLogger(studentID);
    }

    public String authenticateStudent(String id) {
        return authenInterface.authorize(id, false);
    }
    ...
    private String bookRoom(Scanner scanner, String studentId){
        ...
        List<String> listOfTimeSlots = Arrays.asList(drrsServerInterface.getTimeSlots(date, room, campus));
